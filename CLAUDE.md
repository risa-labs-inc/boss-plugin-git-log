...
**Git Log (Dynamic)** (`ai.rever.boss.plugin.dynamic.gitlog`) is a dynamic plugin for the BOSS desktop application.

View commit history with graph visualization

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.gitlog`
- **Main Class**: `ai.rever.boss.plugin.dynamic.gitlog.GitLogDynamicPlugin`
- **API Version**: 1.0.20
