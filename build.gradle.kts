...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-git-log-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Git Log Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.gitlog.GitLogDynamicPlugin"
        )
    }
